...
// Build CSP connect-src dynamically from environment
const cspConnectSrc = ["'self'", "https://*.supabase.co"];
if (process.env.SUPABASE_URL) {
  cspConnectSrc.push(process.env.SUPABASE_URL);
}
...
// Enhanced AI Routes (multi-module analysis and generation)
const aiEnhancedRoutes = require('./routes/services/ai-enhanced');
