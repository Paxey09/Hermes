              ...
              <td className="px-4 py-3">
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="rounded-lg border border-amber-200 bg-amber-50 px-2 text-sm text-amber-700 hover:bg-amber-100"
                    title="Edit"
                  >
                    ✏️
                  </button>
                  ...
                  <button
                    ...
                    className="rounded-lg border border-blue-200 bg-blue-50 px-2 text-sm text-blue-700 hover:bg-blue-100"
                    title="Create Deal"
                  >
                    🎯
                  </button>
