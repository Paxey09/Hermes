        ...
        return (
          ...
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <div
                className={`flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-2xl border ${cardColorClass(
                  card.color
                )}`}
              >
...
export function DealsPipelineBoard({
  ...
  return (
    <div className="min-w-0 overflow-x-auto pb-2">
      <div className="grid min-w-[1100px] gap-4 xl:min-w-0 xl:grid-cols-6">
        {stages.map((stage) => {
          ...
          return (
            <div
              key={stage}
              className="min-h-[420px] rounded-3xl border border-[var(--border-color)] bg-[var(--bg-card)] p-4 shadow-sm"
            >
