...
function Admin_Dashboard() {
    ...
    const loadDashboardData = async () => {
        try {
            ...
            const [profiles, customers, documents, bookings, projects] = await Promise.all([
                db.getAllProfiles(),
                db.getCustomers(),
                db.getDocuments(),
                db.getDemoBookings(),
            ...
            const activeUsers =
                profiles.data?.filter((p) => p.role === 'Admin' || p.role === 'Client')?.length || 0;
            ...
            const totalRevenue =
                customers.data?.reduce((sum, c) => sum + (parseFloat(c.value) || 0), 0) || 0;
    ...
    const modules = [
        {
            id: 1,
            title: 'CRM',
            description: `Contact registry and customer relationship overview (${stats.totalCustomers} contacts)`,
            icon: (
        ...
        },
        {
            id: 2,
            title: 'Demo Bookings',
            description: `Manage intake, scheduling, and demo completion (${stats.totalBookings} bookings)`,
            icon: (
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" strokeWidth="2">
                    <path d="M8 2v4"></path>
                    <path d="M16 2v4"></path>
        ...
        },
        {
            id: 3,
            title: 'Projects',
            description: `Delivery execution, progress, and assigned members (${stats.totalProjects} projects)`,
            icon: (
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" strokeWidth="2">
    ...
    return (
        <Admin_Layout title="Dashboard">
            ...
            <div className="quick-stats">
                ...
                <div className="quick-stat-card">
                    <div className="quick-stat-icon" style={{ color: '#c9a84c' }}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            <path d="M8 2v4"></path>
                            <path d="M16 2v4"></path>
                            <rect x="3" y="4" width="18" height="18" rx="2"></rect>
                    ...
                    <div className="quick-stat-content">
                        <div className="quick-stat-value">{stats.totalBookings}</div>
                        <div className="quick-stat-label">Demo Bookings</div>
                    </div>
                </div>

                <div className="quick-stat-card">
                    <div className="quick-stat-icon" style={{ color: '#42a5f5' }}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            <rect x="3" y="3" width="18" height="18" rx="2"></rect>
                            <path d="M9 9h6"></path>
                            <path d="M9 15h6"></path>
