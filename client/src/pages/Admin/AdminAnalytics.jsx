  ...
  return (
    <div ref={snapshotRef} style={{ minHeight: "100vh", background: "transparent", padding: "24px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "24px" }}>
        <div>
          <h1 style={{ fontSize: "28px", fontWeight: "700", color: "var(--text-primary)"}}>Analytics Dashboard</h1>
          <p style={{ fontSize: "14px", color: "var(--text-secondary)", margin: 0 }}>Track your business performance and insights</p>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          ...
          <div style={{ display: "flex", gap: "8px" }}>
            <button onClick={exportXLSX} style={{ display: "flex", alignItems: "center", gap: "8px", padding: "10px 16px", borderRadius: "10px", border: "1px solid var(--border-color)", background: "var(--bg-card)", color: "var(--text-primary)", fontSize: "13px", fontWeight: "500", cursor: "pointer" }}>
              <FileSpreadsheet size={16} /> Export XLSX
            </button>
            <button onClick={exportPDF} style={{ display: "flex", alignItems: "center", gap: "8px", padding: "10px 16px", borderRadius: "10px", border: "1px solid var(--border-color)", background: "var(--bg-card)", color: "var(--text-primary)", fontSize: "13px", fontWeight: "500", cursor: "pointer" }}>
