...
import { Users, TrendingUp, DollarSign, Target, UserPlus, BarChart2, BarChart3, PieChart as PieChartIcon, ArrowUpRight, Calendar, CheckCircle, Clock, Server, Database, Shield, Activity, RefreshCw, AlertTriangle, TrendingDown, Eye, FileText, Briefcase, Mail, Phone, MapPin, Star, Zap, Globe, Cpu } from "lucide-react";
...
export default function UnifiedAdminDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <h2 className="text-lg font-semibold text-white flex items-center gap-2">
          <PieChartIcon className="w-5 h-5 text-[#c9a84c]" />
          Intelligence & Analytics
        </h2>
